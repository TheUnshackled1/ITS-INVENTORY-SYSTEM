    ...
    try {
      ...
      window.generateLogRows = function(dataSlice, pageStartIndex) {
        ...
        for (let i = 0; i < len; i++) {
          ...
          let actionBadge = "";
          if (log.action === 'added') {
            actionBadge = `<span class="inline-flex justify-center flex-shrink-0 items-center gap-1.5 w-max px-2.5 py-1 text-[11px] font-bold uppercase tracking-wider text-emerald-700 bg-emerald-100 border border-emerald-200 rounded-full"><svg class="h-1.5 w-1.5 flex-shrink-0 fill-current status-dot-blink" viewBox="0 0 6 6" aria-hidden="true"><circle cx="3" cy="3" r="3" /></svg>Added</span>`;
          } else if (log.action === 'edited') {
            actionBadge = `<span class="inline-flex justify-center flex-shrink-0 items-center gap-1.5 w-max px-2.5 py-1 text-[11px] font-bold uppercase tracking-wider text-blue-700 bg-blue-100 border border-blue-200 rounded-full"><svg class="h-1.5 w-1.5 flex-shrink-0 fill-current status-dot-blink" viewBox="0 0 6 6" aria-hidden="true"><circle cx="3" cy="3" r="3" /></svg>Edited</span>`;
          } else if (log.action === 'deleted') {
            actionBadge = `<span class="inline-flex justify-center flex-shrink-0 items-center gap-1.5 w-max px-2.5 py-1 text-[11px] font-bold uppercase tracking-wider text-rose-700 bg-rose-100 border border-rose-200 rounded-full"><svg class="h-1.5 w-1.5 flex-shrink-0 fill-current status-dot-blink" viewBox="0 0 6 6" aria-hidden="true"><circle cx="3" cy="3" r="3" /></svg>Deleted</span>`;
          } else if (log.action === 'uploaded') {
            actionBadge = `<span class="inline-flex justify-center flex-shrink-0 items-center gap-1.5 w-max px-2.5 py-1 text-[11px] font-bold uppercase tracking-wider text-purple-700 bg-purple-100 border border-purple-200 rounded-full"><svg class="h-1.5 w-1.5 flex-shrink-0 fill-current status-dot-blink" viewBox="0 0 6 6" aria-hidden="true"><circle cx="3" cy="3" r="3" /></svg>Uploaded</span>`;
          } else if (log.action === 'borrowed') {
            actionBadge = `<span class="inline-flex justify-center flex-shrink-0 items-center gap-1.5 w-max px-2.5 py-1 text-[11px] font-bold uppercase tracking-wider text-sky-700 bg-sky-100 border border-sky-200 rounded-full"><svg class="h-1.5 w-1.5 flex-shrink-0 fill-current status-dot-blink" viewBox="0 0 6 6" aria-hidden="true"><circle cx="3" cy="3" r="3" /></svg>Borrowed</span>`;
          } else if (log.action === 'returned') {
            actionBadge = `<span class="inline-flex justify-center flex-shrink-0 items-center gap-1.5 w-max px-2.5 py-1 text-[11px] font-bold uppercase tracking-wider text-slate-600 bg-slate-100 border border-slate-200 rounded-full"><svg class="h-1.5 w-1.5 flex-shrink-0 fill-current status-dot-blink" viewBox="0 0 6 6" aria-hidden="true"><circle cx="3" cy="3" r="3" /></svg>Returned</span>`;
          } else {
            actionBadge = `<span class="inline-flex justify-center flex-shrink-0 items-center gap-1.5 w-max px-2.5 py-1 text-[11px] font-bold uppercase tracking-wider text-slate-700 bg-slate-100 border border-slate-200 rounded-full"><svg class="h-1.5 w-1.5 flex-shrink-0 fill-current status-dot-blink" viewBox="0 0 6 6" aria-hidden="true"><circle cx="3" cy="3" r="3" /></svg>${escapeHtml(log.action)}</span>`;
          }
